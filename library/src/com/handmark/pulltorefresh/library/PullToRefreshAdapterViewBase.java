...
public abstract class PullToRefreshAdapterViewBase<T extends ListView> extends PullToRefreshBase<T> implements
    ...
    private void init(Context context) {
        ...
        mHeaderView = (RelativeLayout) mInflater.inflate(
                R.layout.load_more_header, this, false);

        mProgressBarLoadMore = (ProgressBar) mHeaderView
     ...
     * when the Adapter View is scrolled to the top and the mode is set to {@link Mode#PULL_FROM_START}. The default
     * value is <var>true</var> if {@link PullToRefreshBase#isPullToRefreshOverScrollEnabled()
    ...
    public void onLoadMore() {
        Log.e(PullToRefreshAdapterViewBase.class.getName(), "onLoadMore");
        if (mOnLoadMoreListener != null) {
     ...
     * getRefreshableView()}. {@link AdapterView#setAdapter(android.widget.Adapter)} setAdapter(adapter)}. This is just
     * for convenience!
     * @param adapter
     *            - Adapter to set
     */
